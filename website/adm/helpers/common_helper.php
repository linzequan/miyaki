 ...
 * 根据图片名称 生成图片访问链接
 *
 * @param string $img_url_name
 * @return string
 */
function get_img_show_url($img_url_name=''){
    global $system_app;
    if($img_url_name==''){
        $img_url_name='0-0.jpg';
    }
    return 'http://'.$system_app['img'].'/image/show/'.$img_url_name;
}


function get_img_upload_url(){
    global $system_app;
    return 'http://'.$system_app['img'].'/image/upload/';
}
